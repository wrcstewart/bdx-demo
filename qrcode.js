...
// rendered, and decoded with OpenCV's detector. All 25 came back byte for
// byte. (An earlier check that compared its matrix against segno's "failed"
// and was itself wrong: segno defaults to making MICRO QR codes, a different
// symbol. Decoding is the test that means anything.)
//
// Left unminified so it can be read and audited, which is the same reason
